 ...
 * @ingroup world
 */
ODE_API void dWorldStep (dWorldID w, dReal stepsize);
...
ODE_API void dWorldAddBody		(dWorldID,dBodyID);
ODE_API void dWorldAddJoint		(dWorldID,dJointID);
ODE_API void dWorldRemoveBody	(dWorldID,dBodyID);
ODE_API void dWorldRemoveJoint	(dWorldID,dJointID);
 ...
 */
ODE_API_DEPRECATED ODE_API void dJointSetHinge2Axis1 (dJointID, dReal x, dReal y, dReal z);
 ...
 * @see dJointSetHinge2Axes
 */
ODE_API_DEPRECATED ODE_API void dJointSetHinge2Axis2 (dJointID, dReal x, dReal y, dReal z);
...
ODE_API void dJointSetFixedQuaternionPos (dJointID joint,dQuaternion quaternion,dReal* pos);
