...
void setBall( dxJoint *joint, const dxJoint::Info2 *info,
			    dVector3 anchor1, dVector3 anchor2)
{
  ...
  info->J1l[2*s+2] = 1;
    ...
    info->J2l[s+1] = -1;
    info->J2l[2*s+2] = -1;
        dMultiply0_331( a2, b1->R, anchor2 );
...
void setBall2( dxJoint *joint, const dxJoint::Info2 *info,
			    dVector3 anchor1, dVector3 anchor2,
...
void setFixedOrientation( dxJoint *joint, const dxJoint::Info2 *info, dQuaternion qrel, int start_row )
{
  int s = info->rowskip;
  ...
  dQuaternion qerr,e;
    ...
    dMultiply0_331( e, b0->R, qerr + 1 );  // @@@ bad SIMD padding!
  dReal k = info->fps * info->erp;
...
void getAnchor (dxJoint *j, dVector3 result, dVector3 anchor1)
{
    ...
    if ( b0 )
    {
    dMULTIPLY0_331 (result, b0->R, anchor1);
        result[0] += b0->pos[0];
        result[1] += b0->pos[1];
        result[2] += b0->pos[2];
  }
...
void getAnchor2 (dxJoint *j, dVector3 result, dVector3 anchor2)
{
    ...
    if ( b1 )
    {
    dMULTIPLY0_331 (result, b1->R, anchor2);
        result[0] += b1->pos[0];
        result[1] += b1->pos[1];
        result[2] += b1->pos[2];
  }
...
void getAxis (dxJoint *j, dVector3 result, dVector3 axis1)
{
    ...
    if ( b0 )
    {
    dMULTIPLY0_331 (result, b0->R, axis1);
  }
}
...
void getAxis2 (dxJoint *j, dVector3 result, dVector3 axis2)
{
    ...
    if ( b1 )
    {
    dMULTIPLY0_331 (result, b1->R, axis2);
  }
    else
    {
    result[0] = axis2[0];
...
bool dxJointLimitMotor::addLimot (dxJoint *joint,
    const dxJoint::Info2 *info, int row,
  ...
  int powered = fmax > 0;
    ...
    dVector3 ltd = {0,0,0}; // Linear Torque Decoupling vector (a torque)
        if ( !rotational && b1 )
        {
            dxBody *b0 = joint->node[0].body;
      dVector3 c;
            c[0] = REAL( 0.5 ) * ( b1->pos[0] - b0->pos[0] );
            c[1] = REAL( 0.5 ) * ( b1->pos[1] - b0->pos[1] );
            c[2] = REAL( 0.5 ) * ( b1->pos[2] - b0->pos[2] );
...
extern "C" void dJointSetBallAnchor (dJointID j, dReal x, dReal y, dReal z)
{
...
extern "C" void dJointSetBallAnchor2 (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointBall* joint = (dxJointBall*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dball_vtable,"joint is not a ball");
...
extern "C" void dJointGetBallAnchor (dJointID j, dVector3 result)
{
  dxJointBall* joint = (dxJointBall*)j;
  dUASSERT(joint,"bad joint argument");
...
extern "C" void dJointGetBallAnchor2 (dJointID j, dVector3 result)
{
  dxJointBall* joint = (dxJointBall*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointSetHingeAnchor (dJointID j, dReal x, dReal y, dReal z)
{
...
extern "C" void dJointSetHingeAnchorDelta (dJointID j, dReal x, dReal y, dReal z, dReal dx, dReal dy, dReal dz)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge_vtable,"joint is not a hinge");
...
extern "C" void dJointSetHingeAxis (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge_vtable,"joint is not a hinge");
...
extern "C" void dJointGetHingeAnchor (dJointID j, dVector3 result)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetHingeAnchor2 (dJointID j, dVector3 result)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetHingeAxis (dJointID j, dVector3 result)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointSetHingeParam (dJointID j, int parameter, dReal value)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge_vtable,"joint is not a hinge");
...
extern "C" dReal dJointGetHingeParam (dJointID j, int parameter)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge_vtable,"joint is not a hinge");
...
extern "C" dReal dJointGetHingeAngle (dJointID j)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__dhinge_vtable,"joint is not a hinge");
...
extern "C" dReal dJointGetHingeAngleRate (dJointID j)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__dhinge_vtable,"joint is not a Hinge");
...
extern "C" void dJointAddHingeTorque (dJointID j, dReal torque)
{
  dxJointHinge* joint = (dxJointHinge*)j;
  dVector3 axis;
  dAASSERT(joint);
...
extern "C" dReal dJointGetSliderPosition (dJointID j)
{
...
extern "C" dReal dJointGetSliderPositionRate (dJointID j)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dslider_vtable,"joint is not a slider");
...
extern "C" void dJointSetSliderAxis (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  int i;
  dUASSERT(joint,"bad joint argument");
...
extern "C" void dJointSetSliderAxisDelta (dJointID j, dReal x, dReal y, dReal z, dReal dx, dReal dy, dReal dz)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  int i;
  dUASSERT(joint,"bad joint argument");
...
extern "C" void dJointGetSliderAxis (dJointID j, dVector3 result)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointSetSliderParam (dJointID j, int parameter, dReal value)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dslider_vtable,"joint is not a slider");
...
extern "C" dReal dJointGetSliderParam (dJointID j, int parameter)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dslider_vtable,"joint is not a slider");
...
extern "C" void dJointAddSliderForce (dJointID j, dReal force)
{
  dxJointSlider* joint = (dxJointSlider*)j;
  dVector3 axis;
  dUASSERT(joint,"bad joint argument");
...
static void contactGetInfo2 (dxJointContact *j, dxJoint::Info2 *info)
{
  ...
  dVector3 c1,c2;
  c1[0] = j->contact.geom.pos[0] - j->node[0].body->pos[0];
  c1[1] = j->contact.geom.pos[1] - j->node[0].body->pos[1];
  c1[2] = j->contact.geom.pos[2] - j->node[0].body->pos[2];
  ...
  if (j->node[1].body) {
    c2[0] = j->contact.geom.pos[0] - j->node[1].body->pos[0];
    c2[1] = j->contact.geom.pos[1] - j->node[1].body->pos[1];
    c2[2] = j->contact.geom.pos[2] - j->node[1].body->pos[2];
    info->J2l[0] = -normal[0];
    info->J2l[1] = -normal[1];
    info->J2l[2] = -normal[2];
...
extern "C" void dJointSetHinge2Anchor (dJointID j, dReal x, dReal y, dReal z)
{
...
extern "C" void dJointSetHinge2Axis1 (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" void dJointSetHinge2Axis2 (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" void dJointSetHinge2Param (dJointID j, int parameter, dReal value)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" void dJointGetHinge2Anchor (dJointID j, dVector3 result)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetHinge2Anchor2 (dJointID j, dVector3 result)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetHinge2Axis1 (dJointID j, dVector3 result)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetHinge2Axis2 (dJointID j, dVector3 result)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" dReal dJointGetHinge2Param (dJointID j, int parameter)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" dReal dJointGetHinge2Angle1 (dJointID j)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" dReal dJointGetHinge2Angle1Rate (dJointID j)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" dReal dJointGetHinge2Angle2Rate (dJointID j)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__dhinge2_vtable,"joint is not a hinge2");
...
extern "C" void dJointAddHinge2Torques (dJointID j, dReal torque1, dReal torque2)
{
  dxJointHinge2* joint = (dxJointHinge2*)j;
...
extern "C" void dJointSetUniversalAnchor (dJointID j, dReal x, dReal y, dReal z)
{
...
extern "C" void dJointSetUniversalAxis1 (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" void dJointSetUniversalAxis2 (dJointID j, dReal x, dReal y, dReal z)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" void dJointGetUniversalAnchor (dJointID j, dVector3 result)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetUniversalAnchor2 (dJointID j, dVector3 result)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetUniversalAxis1 (dJointID j, dVector3 result)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointGetUniversalAxis2 (dJointID j, dVector3 result)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(result,"bad result argument");
...
extern "C" void dJointSetUniversalParam (dJointID j, int parameter, dReal value)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" dReal dJointGetUniversalParam (dJointID j, int parameter)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" dReal dJointGetUniversalAngle1 (dJointID j)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" dReal dJointGetUniversalAngle2 (dJointID j)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" dReal dJointGetUniversalAngle1Rate (dJointID j)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" dReal dJointGetUniversalAngle2Rate (dJointID j)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dUASSERT(joint,"bad joint argument");
  dUASSERT(joint->vtable == &__duniversal_vtable,"joint is not a universal");
...
extern "C" void dJointAddUniversalTorques (dJointID j, dReal torque1, dReal torque2)
{
  dxJointUniversal* joint = (dxJointUniversal*)j;
  dVector3 axis1, axis2;
  dAASSERT(joint);
...
dReal dJointGetPRPosition (dJointID j)
{
  ...
  dMULTIPLY0_331 (q,joint->node[0].body->R,joint->offset);

  if (joint->node[1].body) {
    dVector3 anchor2;

    // get the anchor2 in global coordinates
    dMULTIPLY0_331 (anchor2,joint->node[1].body->R,joint->anchor2);

    q[0] = ( (joint->node[0].body->pos[0] + q[0]) -
             (joint->node[1].body->pos[0] + anchor2[0]) );
    q[1] = ( (joint->node[0].body->pos[1] + q[1]) -
             (joint->node[1].body->pos[1] + anchor2[1]) );
    q[2] = ( (joint->node[0].body->pos[2] + q[2]) -
             (joint->node[1].body->pos[2] + anchor2[2]) );
  ...
  dMULTIPLY0_331 (axP,joint->node[0].body->R,joint->axisP1);
...
dReal dJointGetPRPositionRate (dJointID j)
{
  ...
  if (joint->node[0].body) {
		...
		if (joint->node[1].body) {
			...
			r[0] = joint->node[0].body->pos[0] - anchor2[0];
			r[1] = joint->node[0].body->pos[1] - anchor2[1];
			r[2] = joint->node[0].body->pos[2] - anchor2[2];
		}
		else {
			//N.B. When there is no body 2 the joint->anchor2 is already in
			//     global coordinates
			r[0] = joint->node[0].body->pos[0] - joint->anchor2[0];
			r[1] = joint->node[0].body->pos[1] - joint->anchor2[1];
			r[2] = joint->node[0].body->pos[2] - joint->anchor2[2];
		}
		...
		dVector3 angular;
		dMULTIPLY0_331 (angular,joint->node[0].body->R,joint->axisR1);
		...
		dVector3 axP1;
		dMULTIPLY0_331 (axP1,joint->node[0].body->R,joint->axisP1);
...
static void PRGetInfo2 (dxJointPR *joint, dxJoint::Info2 *info)
{
  ...
  // are the angular velocity vectors of the two bodies.
  dVector3 ax1;
  dMULTIPLY0_331 (ax1, joint->node[0].body->R, joint->axisR1);
  dCROSS(q , =, ax1, axP);
...
void dJointSetPRAxis1 (dJointID j, dReal x, dReal y, dReal z)
{
  ...
  if (joint->node[1].body) {
    ...
    c[0] = ( joint->node[1].body->pos[0] + anchor2[0] -
             joint->node[0].body->pos[0] );
    c[1] = ( joint->node[1].body->pos[1] + anchor2[1] -
             joint->node[0].body->pos[1] );
    c[2] = ( joint->node[1].body->pos[2] + anchor2[2] -
             joint->node[0].body->pos[2] );
  }
  else if (joint->node[0].body) {
    c[0] = joint->anchor2[0] - joint->node[0].body->pos[0];
    c[1] = joint->anchor2[1] - joint->node[0].body->pos[1];
    c[2] = joint->anchor2[2] - joint->node[0].body->pos[2];
  }
	else
	{
  ...
  dMULTIPLY1_331 (joint->offset,joint->node[0].body->R,c);
}
...
extern "C" void dJointSetAMotorNumAxes (dJointID j, int num)
{
...
extern "C" void dJointSetAMotorAxis (dJointID j, int anum, int rel, dReal x, dReal y, dReal z)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
...
extern "C" void dJointSetAMotorAngle (dJointID j, int anum, dReal angle)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
...
extern "C" void dJointSetAMotorParam (dJointID j, int parameter, dReal value)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" void dJointSetAMotorMode (dJointID j, int mode)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" int dJointGetAMotorNumAxes (dJointID j)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" void dJointGetAMotorAxis (dJointID j, int anum, dVector3 result)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint && anum >= 0 && anum < 3);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" int dJointGetAMotorAxisRel (dJointID j, int anum)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint && anum >= 0 && anum < 3);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" dReal dJointGetAMotorAngle (dJointID j, int anum)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint && anum >= 0 && anum < 3);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" dReal dJointGetAMotorAngleRate (dJointID j, int anum)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  // @@@
...
extern "C" dReal dJointGetAMotorParam (dJointID j, int parameter)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" int dJointGetAMotorMode (dJointID j)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dAASSERT(joint);
  dUASSERT(joint->vtable == &__damotor_vtable,"joint is not an amotor");
...
extern "C" void dJointAddAMotorTorques (dJointID j, dReal torque1, dReal torque2, dReal torque3)
{
  dxJointAMotor* joint = (dxJointAMotor*)j;
  dVector3 axes[3];
  dAASSERT(joint);
...
extern "C" void dJointSetFixed (dJointID j)
{
