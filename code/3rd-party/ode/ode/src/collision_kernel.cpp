...
static void initColliders()
{
  ...
  setCollider (dTriMeshClass,dCCylinderClass,&dCollideCCTL);
    ...
    setCollider (dCCylinderClass,dTriMeshClass,&dCollideCCylinderTrimesh);
	...
	setCollider (dCCylinderClass, dCylinderClass, &dCollideCCylinderCCylinder);
#endif
...
void dGeomGetPosRelPoint (dGeomID g, dReal px, dReal py, dReal pz, dVector3 result)
{
    ...
    prel[2] = pz - g->pos[2];
    prel[3] = 0;
    dMultiply1_331 (result,g->R,prel);
}
